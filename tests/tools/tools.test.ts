...
describe('getAccounts - net worth calculation', () => {
  let db: CopilotDatabase;
  let tools: CopilotMoneyTools;
  ...
  test('correctly calculates net worth with mixed account types', async () => {
  ...
  test('correctly handles only asset accounts', async () => {
  ...
  test('correctly handles only liability accounts', async () => {
